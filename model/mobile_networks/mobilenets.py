...
from model.mobile_networks.depthwise_conv import DepthwiseConvolution2D
...
if __name__ == "__main__":
    ...
    model = MobileNets(input_shape=(224, 224, 3), alpha=1, include_top=False)
    model.summary()
